            ...
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <jet-nav-link :href="route('dashboard.home')"
                                              :active="route().current('dashboard.home')">
                                    Dashboard
                                </jet-nav-link>
                                <jet-nav-link :href="route('dashboard.me.orders')"
                                              :active="route().current('dashboard.me.orders')">
                                    Mijn Bestellingen
                                </jet-nav-link>
                                <jet-nav-link v-if="$page.props.user.is_admin" :href="route('dashboard.admin')"
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}"
                    ...
                    <div class="pt-2 pb-3 space-y-1">
                        <jet-responsive-nav-link :href="route('dashboard.home')"
                                                 :active="route().current('dashboard.home')">
                            Dashboard
                        </jet-responsive-nav-link>
                        <jet-responsive-nav-link :href="route('dashboard.me.orders')"
                                                 :active="route().current('dashboard.me.orders')">
                            Mijn Bestellingen
                        </jet-responsive-nav-link>
                        <jet-responsive-nav-link v-if="$page.props.user.is_admin" :href="route('dashboard.admin')"
                                                 :active="route().current('dashboard.admin')">
                            Admin
                        </jet-responsive-nav-link>
