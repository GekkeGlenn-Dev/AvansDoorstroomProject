...
Route::post('winkelmandje/product/toevoegen/{product:slug}', [BasketController::class, 'addProduct'])->name('shop.product.add');
Route::post('winkelmandje/product/verwijder/{product:slug}', [BasketController::class, 'removeProduct'])->name('shop.product.remove');
...
Route::middleware(ProductsOnBasketCheck::class)->post('winkelmandje/uitchecken', [OrderController::class, 'store'])->name('basket.checkout.process');
